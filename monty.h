...
/**
 * struct arg_s - contents of command argument and checks flag
 * @arg: command argument
 * @flag: check command flag
 *
 * Description: command line argument and checks for command flag
 */
...
/**
 * struct meta_s - content of buffer, stack pointer and file pointer
 * @buf: buffer pointer
 * @stack: points to stacks or queues
 * @file: points to the file
 *
 * Description: content of buffer, stack pointer and file pointer
 */
